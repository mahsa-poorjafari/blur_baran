...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { description_en: @slide.description_en, description_fa: @slide.description_fa }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { description_en: @slide.description_en, description_fa: @slide.description_fa }
    assert_redirected_to slide_path(assigns(:slide))
  end
